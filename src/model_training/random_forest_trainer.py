...
def main():
    ...
    if df is not None and not df.empty:
        ...
        logger.info(f"📈 **🔍 EXTREMELY DETAILED Random Forest DATA ANALYSIS:**")
        ...
        data_summary = f"""📊 **🔍 DETAILED Random Forest Training Data:**
...
• 🔄 Processing {sufficient_symbols.sum():,} rows for Random Forest training..."""
        send_rf_trainer_notification(data_summary)
    else:
